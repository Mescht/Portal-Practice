...
# back to lobby
setblock 0 34 29 minecraft:oak_wall_sign[facing=south]{Color:"black",Text4:'{"text":""}',Text3:'{"text":""}',Text2:'{"color":"gold","clickEvent":{"action":"run_command","value":"function portal:back_to_lobby"},"text":"Back to Lobby"}',Text1:'{"text":""}'}

# options
setblock 0 35 29 minecraft:oak_wall_sign[facing=south]{Color:"black",Text4:'{"text":""}',Text3:'{"text":""}',Text2:'{"color":"yellow","clickEvent":{"action":"run_command","value":"function portal:options/menu"},"text":"Options"}',Text1:'{"text":""}'}
