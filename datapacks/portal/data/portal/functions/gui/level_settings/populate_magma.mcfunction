...
execute if score disabled filter matches 1 run data modify storage portal:gui settings[{tag:{index:24b}}].tag.display.Lore set value ['{"text":"Enbaled","color":"green"}']
